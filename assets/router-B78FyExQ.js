(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&l(d)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();const e={localhost:"localhost",deployPath:"/front_5th_chapter1-1",blankPath:"",lsKey:{users:"users",user:"user"},loginForm:{formId:"login-form",field:{username:"username",password:"password"}},profileForm:{formId:"profile-form",field:{username:"username",email:"email",bio:"bio"}},pathname:{main:"/",login:"/login",profile:"/profile"}},y=localStorage.getItem(e.lsKey.users)||"[]",w=JSON.parse(y),x=localStorage.getItem(e.lsKey.user)||"null",P=JSON.parse(x),a={users:w,loggedInUser:P,initUser({username:n}){return{username:n,email:"",bio:""}}},I=()=>`
  <header class="bg-blue-600 text-white p-4 sticky top-0">
    <h1 class="text-2xl font-bold">항해플러스</h1>
  </header>
`,g={template:I,onMount:()=>{}},$=()=>`
    <footer class="bg-gray-200 p-4 text-center">
        <p>&copy; 2024 항해플러스. All rights reserved.</p>
    </footer>
`,p={template:$,onMount:()=>{}},F=()=>{const n=t=>(console.log(window.router.getCurrentPath()),window.router.getCurrentPath()===t?"text-blue-600 font-bold":"text-gray-600");return`
  ...
  `,onMount:()=>{const n=document.getElementById(e.profileForm.formId);if(!n)return;Object.values(e.profileForm.field).forEach(r=>{var o;const l=n.querySelector(`#${r}`);l.value=((o=a.loggedInUser)==null?void 0:o[r])??""}),n.addEventListener("submit",r=>{r.preventDefault();const l=new FormData(n),o=Object.fromEntries(l),s=a.loggedInUser;if(o.username!==s.username||o.email!==s.email||o.bio!==s.bio){const m={...a.loggedInUser,...o},b=a.users.findIndex(v=>v.username===a.loggedInUser.username);a.users.splice(b,1,m),localStorage.setItem(e.lsKey.users,JSON.stringify(a.users)),a.loggedInUser=m,localStorage.setItem(e.lsKey.user,JSON.stringify(m)),alert("profile 변경 완료")}})}},f={template:()=>`
  ...
  `,onMount:()=>{const n=document.getElementById(e.loginForm.formId);n&&n.addEventListener("submit",t=>{t.preventDefault();const r=new FormData(n),{username:l}=Object.fromEntries(r);if(!l)return alert("이름을 입력해주세요");const o=a.users.find(s=>s.username===l);if(o)a.loggedInUser=o;else{const s=a.initUser({username:l});a.loggedInUser=s,a.users.push(s),localStorage.setItem(e.lsKey.users,JSON.stringify(a.users))}localStorage.setItem(e.lsKey.user,JSON.stringify(a.loggedInUser)),window.router.navigate(e.pathname.main)})}},U={template:()=>`
